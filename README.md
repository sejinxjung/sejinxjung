...
기획부터 개발, 운영까지 폭넓게 경험해오며,<br/>
문제를 구조화하고 제품으로 연결하는 과정에 큰 흥미를 느끼고 있습니다.<br/>
새로운 아이디어를 작은 실험으로 빠르게 구현하고,<br/>
지속적으로 다듬어가는 방식을 좋아합니다.<br/>
<br/>
<div>
...
<ul>
  ...
  <li>🤝 팀·외부 파트너와의 커뮤니케이션에서 흐름을 조율하고 정리하는 데 강한 편입니다</li>
</ul>
...
<h2>What I Do</h2>
<ul>
  <li>서비스의 방향성과 구조를 정리하고, 초기 제품 패키지를 빠르게 구성하는 작업</li>
  <li>Figma–Framer–Next.js를 활용해 초기 버전의 흐름을 실제 사용 가능한 형태로 옮기는 작업</li>
